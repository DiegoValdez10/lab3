...
from mathlib import subtractVectors, vectorMagnitude, normVector, dot, multVectorScalar, cross, multVectors, addVectors, \
    addVectorScalar, subtractVectorScalar, vecMean, baricentric
