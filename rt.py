...
from mathlib import normVector, dot, vectorNegative, subtractVectors, reflectVector, addVectors, multVectorScalar, refractVector, totalInternalReflection, fresnel, vectorMagnitude
